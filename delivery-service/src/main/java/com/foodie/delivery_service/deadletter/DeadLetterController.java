...
/** Internal operator API for dead-letter management in delivery-service. */
@RestController
...
public class DeadLetterController {
    ...
    @GetMapping
    public List<DeadLetterDocument> listAll() { return deadLetterService.listAll(); }

    @GetMapping("/pending")
    public List<DeadLetterDocument> listPending() { return deadLetterService.listPending(); }
